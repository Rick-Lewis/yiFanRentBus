            ...
            <TabPane :label="h => label(h, todayVehicle.fetch.total, 'fetch')" name="fetch">
              ...
              >
                <div class="item-content">
                  ...
                  <div class="string"></div>
                  <div class="col-item" style="text-align:center;">
                    <a @click="handleOperate(index, 'fetch')">取车</a>
                  </div>
                </div>
              </div>
            </TabPane>
            <TabPane :label="h => label(h, todayVehicle.return.total, 'return')" name="return">
              ...
              >
                <div class="item-content">
                  ...
                  <div class="string"></div>
                  <div class="col-item" style="text-align:center;">
                    <a @click="handleOperate(index, 'return')">还车</a>
                  </div>
                </div>
              </div>
            </TabPane>
      ...
      switch (text) {
        case '':
          if (this.vehicleOnline.list[index].status === 1) {
            // 取车
            this.$router.push(
              '/home/fetchVehicle?order_no=' +
                this.vehicleOnline.list[index].order_no
            );
          } else if (this.vehicleOnline.list[index].status === 3) {
            // 还车
            this.$router.push(
              '/home/returnVehicle?order_no=' +
                this.vehicleOnline.list[index].order_no
            );
          }
          break;
        ...
        case 'fetch':
          ...
          this.$router.push(
            '/home/fetchVehicle?order_no=' +
              this.todayVehicle.fetch.list[index].order_no
          );
          // temp = {
        ...
        case 'return':
          ...
          this.$router.push(
            '/home/returnVehicle?order_no=' +
              this.todayVehicle.return.list[index].order_no
          );
          // temp = {
